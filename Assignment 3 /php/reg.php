...
<body>
    ...
    <div class="container" style="width: 450px">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <input id="Rrepass" onkeyup="fnc_passSame('Rpass', 'Rrepass', 'Rshow_pass')" type="password" name="rpass" placeholder="Confirm Password" class="field" required="required">
            <p id="Rshow_pass" style="color: red"></p>
            <input type="submit" value="submit" class="btn">
        </form>
        <div class="pass-link">
            <a href="../index.php" style="color: black">Already have an account? Log in</a>
        </div>	
    </div>
</body>
</html>